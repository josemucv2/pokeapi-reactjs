...
export const Profile: React.FC = (): JSX.Element => {
  ...
  return (
    <div className="w-full h-[800px]  flex flex-col justify-center items-center ">
      <div className="w-1/2 phone-1 bg-white text-black h-full rounded-3xl">
        ...
        <div className="grid grid-cols-2 place-items-center place-content-start gap-y-20 w-4/3">
